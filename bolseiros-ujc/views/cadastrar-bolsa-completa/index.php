                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="p-1">
                                ...
                                <select name="curso" class="bg-gray-300 focus:outline-none w-1/2" required>
                                    <option value="ap"></option>
                                    <option value="rid"></option>
                                    <option value="etsi"></option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-1" colspan="3">
                                ...
                                <input type="number" name="contacto1_P" maxlength="11" size="20" class="bg-gray-300 focus:outline-none" required>
                                <input type="text" name="contacts" placeholder="+258" size="4" disabled class="bg-gray-300 focus:outline-none">
                                <input type="number" name="contacto2_P" maxlength="11" class="bg-gray-300 focus:outline-none" required>
                            </td>
                        </tr>
